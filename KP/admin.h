...
private slots:
    ...
    void Charts();
    //Экспорт
    void ExportToSQL(QSqlTableModel *model, const QString &filePath);
    void ExportToCSV(QSqlTableModel *model, const QString &filePath);
    //Импорт
    // void ImportData(QSqlTableModel *model);
    // void ImportFromCSV(QSqlTableModel *model, QTextStream &stream);
    // void ImportFromSQL(QSqlTableModel *model, QTextStream &stream);
    //
    void importFromCSV(QFile& file);
    void importFromSQL(QFile& file);
